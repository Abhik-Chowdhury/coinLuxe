...
const CoinePage = () => {
  ...
  // check the watchlist is conatain any coid or not
    ...
    <div className={classes.container}>
      <div className={classes.sidebar}>
        ...
        <div className={classes.marketData}>
          ...
          {/* The market current price of the coin */}
          <span style={{display:"flex"}}>
          ...
          {/* The market cap of coin */}
          <span style={{display:"flex"}}>
            <Typography variant='h5' className={classes.heading}>Markete Cap:</Typography>
             &nbsp; &nbsp;
            <Typography variant='h5'
             style={{fontFamily:"Montserrat",}}
            >
